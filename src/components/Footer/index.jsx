      ...
      >
        ...
        <Center>
          <Flex
            ...
            fontWeight="bold"
          >
            <Link href={"https://www.sportskeeda.com/about-us"}>About Us</Link>
            <Link href={"https://www.sportskeeda.com/privacy-policy"}>
              Privacy Policy
            </Link>
            <Link href={"https://www.sportskeeda.com/terms-of-use"}>
              Terms of Service
            </Link>
            <Link href={"https://www.sportskeeda.com/contact"}>Contact Us</Link>
            <Link href={"https://www.sportskeeda.com/gdpr-compliance"}>
              GDPR
            </Link>
          </Flex>
        </Center>
